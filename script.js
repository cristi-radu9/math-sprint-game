...
function updateBestScore(){
  bestScoreArray.forEach((score,index)=>{
    if(questionAmount === score.questions.toString()){
...
//Stop timer and process the results
function checkTime(){
  if(playerGuessArray.length.toString() === questionAmount){
    clearInterval(timer);
    //Check for wront guesses
...
function createEquations() {
  ...
  console.log('corect/incorect',correctEquations,wrongEquations)
